...
def main():
    ...
    player_stat_data_df['player_1_average_player_speed'] = player_stat_data_df['player_1_total_player_speed'] / player_stat_data_df['player_2_number_of_shots']
    player_stat_data_df['player_2_average_player_speed'] = player_stat_data_df['player_2_total_player_speed'] / player_stat_data_df['player_1_number_of_shots']
