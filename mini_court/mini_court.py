...
class MiniCourt():
    ...
    def set_court_drawing_key_points(self):
        ...
        #point 5
        drawing_key_points[10] = drawing_key_points[0] + self.convert_meters_to_pixels(constants.DOUBLE_ALLY_DIFFERENCE)
        ...
        #point 7
        drawing_key_points[14] = drawing_key_points[2] - self.convert_meters_to_pixels(constants.DOUBLE_ALLY_DIFFERENCE)
        drawing_key_points[15] = drawing_key_points[5]

        #point 8
        drawing_key_points[16] = drawing_key_points[8]
        drawing_key_points[17] = drawing_key_points[1] + self.convert_meters_to_pixels(constants.NO_MANS_LAND_HEIGHT)
        #point 9
        drawing_key_points[18] = drawing_key_points[8] + self.convert_meters_to_pixels(constants.SINGLE_LINE_WIDTH)
        drawing_key_points[19] = drawing_key_points[17]
        #point 10
        drawing_key_points[20] = drawing_key_points[8]
    ...
    def draw_background_rectangle(self, frame):
        ...
        cv2.rectangle(shape, (self.start_x, self.start_y), (self.end_x, self.end_y), (255,255,255), -1)

        out = frame.copy()
        alpha = 0.2
        mask = shape.astype(bool)
        out[mask] = cv2.addWeighted(frame, alpha, shape, 1-alpha, 0)[mask]
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self, player_boxes, ball_boxes, original_court_key_points):
        ...
        player_heights = {
            1: constants.PLAYER_1_HEIGHT_METER,
            2: constants.PLAYER_2_HEIGHT_METER
        }
